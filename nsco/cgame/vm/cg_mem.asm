...
file "../cg_mem.c"
line 23
;1:// Copyright (C) 2003-2003 team-mirage
;2://
;3://
;4:// cg_mem.c - dynamic memory pool written for regexp
;5://
;6:
;7:// every line of code is property of manfred nerurkar
...
;14:
;15:
;16:#define POOLSIZE	(256 * 1024)
;17:
;18:static char		cg_memoryPool[POOLSIZE];
;19:static int		cg_allocPoint;
;20:
;21:vmCvar_t	cg_debugAlloc;
;22:
;23:void *CG_Alloc( int size ) {
line 26
;24:	char	*p;
;25:
;26:	if ( cg_debugAlloc.integer ) {
ADDRGP4 cg_debugAlloc+12
INDIRI4
CNSTI4 0
EQI4 $85
line 27
;27:		CG_Printf( "CG_Alloc of 7%i bytes (%i left)\n", size, POOLSIZE - cg_allocPoint - ( ( size + 31 ) & ~31 ) );
ADDRGP4 $88
ARGP4
ADDRLP4 4
ADDRFP4 0
...
line 30
;29:
;30:	if ( cg_allocPoint + size > POOLSIZE ) {
ADDRGP4 cg_allocPoint
INDIRI4
ADDRFP4 0
INDIRI4
...
LEI4 $89
line 31
;31:		CG_Error( "CG_Alloc: failed on allocation of %u bytes\n", size );
ADDRGP4 $91
ARGP4
ADDRFP4 0
INDIRI4
...
;33:	}
;34:
;35:	p = &cg_memoryPool[cg_allocPoint];
ADDRLP4 0
ADDRGP4 cg_allocPoint
INDIRI4
ADDRGP4 cg_memoryPool
ADDP4
ASGNP4
line 37
;36:
;37:	cg_allocPoint += ( size + 31 ) & ~31;
ADDRLP4 4
ADDRGP4 cg_allocPoint
ASGNP4
ADDRLP4 4
...
RETP4
LABELV $84
endproc CG_Alloc 8 12
export CG_InitMemory
proc CG_InitMemory 0 0
line 42
;40:}
;41:
;42:void CG_InitMemory( void ) {
line 43
;43:	cg_allocPoint = 0;
ADDRGP4 cg_allocPoint
CNSTI4 0
...
export CG_GameMem_f
proc CG_GameMem_f 0 12
line 46
;45:
;46:void CG_GameMem_f( void ) {
line 47
;47:	CG_Printf( "CGame memory status: %i out of %i bytes allocated\n", cg_allocPoint, POOLSIZE );
ADDRGP4 $94
ARGP4
ADDRGP4 cg_allocPoint
INDIRI4
...
;48:}
LABELV $93
endproc CG_GameMem_f 0 12
bss
align 4
LABELV cg_allocPoint
skip 4
align 1
LABELV cg_memoryPool
skip 262144
