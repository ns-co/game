...
// Navy Seals ++
	...
	qhandle_t	gibHeadShotFace;
	qhandle_t	gibHeadShotNeck;
	qhandle_t	gibHeadShotBlown;
...
//	qhandle_t	ingameMenuTopShader;
//	qhandle_t	ingameMenuBottomShader;
...
extern vmCvar_t cg_bulletpredict;
