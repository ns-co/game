...
;11:
;12:// this file is only included when building a dll
;13:// g_syscalls.asm is included instead when building a qvm
;14:
;15:static int (QDECL *syscall)( int arg, ... ) = (int (QDECL *)( int, ...))-1;
;16:
;17:
;18:void dllEntry( int (QDECL *syscallptr)( int arg,... ) ) {
line 19
;19:	syscall = syscallptr;
ADDRGP4 syscall
ADDRFP4 0
INDIRP4
ASGNP4
...
;26:}
;27:
;28:void	trap_Printf( const char *fmt ) {
line 29
;29:	syscall( G_PRINT, fmt );
CNSTI4 0
ARGI4
ADDRFP4 0
INDIRP4
...
line 32
;31:
;32:void	trap_Error( const char *fmt ) {
line 33
;33:	syscall( G_ERROR, fmt );
CNSTI4 1
ARGI4
ADDRFP4 0
INDIRP4
...
line 36
;35:
;36:int		trap_Milliseconds( void ) {
line 37
;37:	return syscall( G_MILLISECONDS ); 
CNSTI4 2
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
line 39
;38:}
;39:int		trap_Argc( void ) {
line 40
;40:	return syscall( G_ARGC );
CNSTI4 8
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;41:}
;42:
;43:void	trap_Argv( int n, char *buffer, int bufferLength ) {
line 44
;44:	syscall( G_ARGV, n, buffer, bufferLength );
CNSTI4 9
ARGI4
ADDRFP4 0
INDIRI4
...
line 47
;46:
;47:int		trap_FS_FOpenFile( const char *qpath, fileHandle_t *f, fsMode_t mode ) {
line 48
;48:	return syscall( G_FS_FOPEN_FILE, qpath, f, mode );
CNSTI4 10
ARGI4
ADDRFP4 0
INDIRP4
...
;49:}
;50:
;51:void	trap_FS_Read( void *buffer, int len, fileHandle_t f ) {
line 52
;52:	syscall( G_FS_READ, buffer, len, f );
CNSTI4 11
ARGI4
ADDRFP4 0
INDIRP4
...
line 55
;54:
;55:void	trap_FS_Write( const void *buffer, int len, fileHandle_t f ) {
line 56
;56:	syscall( G_FS_WRITE, buffer, len, f );
CNSTI4 12
ARGI4
ADDRFP4 0
INDIRP4
...
line 59
;58:
;59:void	trap_FS_FCloseFile( fileHandle_t f ) {
line 60
;60:	syscall( G_FS_FCLOSE_FILE, f );
CNSTI4 13
ARGI4
ADDRFP4 0
INDIRI4
...
line 63
;62:
;63:int trap_FS_GetFileList(  const char *path, const char *extension, char *listbuf, int bufsize ) {
line 64
;64:	return syscall( G_FS_GETFILELIST, path, extension, listbuf, bufsize );
CNSTI4 38
ARGI4
ADDRFP4 0
INDIRP4
...
line 133
;132:
;133:int trap_PointContents( const vec3_t point, int passEntityNum ) {
line 134
;134:	return syscall( G_POINT_CONTENTS, point, passEntityNum );
CNSTI4 25
ARGI4
ADDRFP4 0
INDIRP4
...
;136:
;137:
;138:qboolean trap_InPVS( const vec3_t p1, const vec3_t p2 ) {
line 139
;139:	return syscall( G_IN_PVS, p1, p2 );
CNSTI4 26
ARGI4
ADDRFP4 0
INDIRP4
...
;140:}
;141:
;142:qboolean trap_InPVSIgnorePortals( const vec3_t p1, const vec3_t p2 ) {
line 143
;143:	return syscall( G_IN_PVS_IGNORE_PORTALS, p1, p2 );
CNSTI4 27
ARGI4
ADDRFP4 0
INDIRP4
...
;144:}
;145:
;146:void trap_AdjustAreaPortalState( gentity_t *ent, qboolean open ) {
line 147
;147:	syscall( G_ADJUST_AREA_PORTAL_STATE, ent, open );
CNSTI4 28
ARGI4
ADDRFP4 0
INDIRP4
...
line 150
;149:
;150:qboolean trap_AreasConnected( int area1, int area2 ) {
line 151
;151:	return syscall( G_AREAS_CONNECTED, area1, area2 );
CNSTI4 29
ARGI4
ADDRFP4 0
INDIRI4
...
;152:}
;153:
;154:void trap_LinkEntity( gentity_t *ent ) {
line 155
;155:	syscall( G_LINKENTITY, ent );
CNSTI4 30
ARGI4
ADDRFP4 0
INDIRP4
...
line 158
;157:
;158:void trap_UnlinkEntity( gentity_t *ent ) {
line 159
;159:	syscall( G_UNLINKENTITY, ent );
CNSTI4 31
ARGI4
ADDRFP4 0
INDIRP4
...
line 162
;161:
;162:int trap_EntitiesInBox( const vec3_t mins, const vec3_t maxs, int *list, int maxcount ) {
line 163
;163:	return syscall( G_ENTITIES_IN_BOX, mins, maxs, list, maxcount );
CNSTI4 32
ARGI4
ADDRFP4 0
INDIRP4
...
;164:}
;165:
;166:qboolean trap_EntityContact( const vec3_t mins, const vec3_t maxs, const gentity_t *ent ) {
line 167
;167:	return syscall( G_ENTITY_CONTACT, mins, maxs, ent );
CNSTI4 33
ARGI4
ADDRFP4 0
INDIRP4
...
;168:}
;169:
;170:int trap_BotAllocateClient( void ) {
line 171
;171:	return syscall( G_BOT_ALLOCATE_CLIENT );
CNSTI4 34
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;172:}
;173:
;174:void trap_BotFreeClient( int clientNum ) {
line 175
;175:	syscall( G_BOT_FREE_CLIENT, clientNum );
CNSTI4 35
ARGI4
ADDRFP4 0
INDIRI4
...
line 178
;177:
;178:void trap_GetUsercmd( int clientNum, usercmd_t *cmd ) {
line 179
;179:	syscall( G_GET_USERCMD, clientNum, cmd );
CNSTI4 36
ARGI4
ADDRFP4 0
INDIRI4
...
line 182
;181:
;182:qboolean trap_GetEntityToken( char *buffer, int bufferSize ) {
line 183
;183:	return syscall( G_GET_ENTITY_TOKEN, buffer, bufferSize );
CNSTI4 37
ARGI4
ADDRFP4 0
INDIRP4
...
;184:}
;185:
;186:int trap_DebugPolygonCreate(int color, int numPoints, vec3_t *points) {
line 187
;187:	return syscall( G_DEBUG_POLYGON_CREATE, color, numPoints, points );
CNSTI4 39
ARGI4
ADDRFP4 0
INDIRI4
...
;188:}
;189:
;190:void trap_DebugPolygonDelete(int id) {
line 191
;191:	syscall( G_DEBUG_POLYGON_DELETE, id );
CNSTI4 40
ARGI4
ADDRFP4 0
INDIRI4
...
line 194
;193:
;194:int trap_RealTime( qtime_t *qtime ) {
line 195
;195:	return syscall( G_REAL_TIME, qtime );
CNSTI4 41
ARGI4
ADDRFP4 0
INDIRP4
...
;196:}
;197:
;198:void trap_SnapVector( float *v ) {
line 199
;199:	syscall( G_SNAPVECTOR, v );
CNSTI4 42
ARGI4
ADDRFP4 0
INDIRP4
...
;201:}
;202:
;203:// BotLib traps start here
;204:int trap_BotLibSetup( void ) {
line 205
;205:	return syscall( BOTLIB_SETUP );
CNSTI4 200
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;206:}
;207:
;208:int trap_BotLibShutdown( void ) {
line 209
;209:	return syscall( BOTLIB_SHUTDOWN );
CNSTI4 201
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;210:}
;211:
;212:int trap_BotLibVarSet(char *var_name, char *value) {
line 213
;213:	return syscall( BOTLIB_LIBVAR_SET, var_name, value );
CNSTI4 202
ARGI4
ADDRFP4 0
INDIRP4
...
;214:}
;215:
;216:int trap_BotLibVarGet(char *var_name, char *value, int size) {
line 217
;217:	return syscall( BOTLIB_LIBVAR_GET, var_name, value, size );
CNSTI4 203
ARGI4
ADDRFP4 0
INDIRP4
...
;218:}
;219:
;220:int trap_BotLibDefine(char *string) {
line 221
;221:	return syscall( BOTLIB_PC_ADD_GLOBAL_DEFINE, string );
CNSTI4 204
ARGI4
ADDRFP4 0
INDIRP4
...
;222:}
;223:
;224:int trap_BotLibStartFrame(float time) {
line 225
;225:	return syscall( BOTLIB_START_FRAME, PASSFLOAT( time ) );
ADDRFP4 0
INDIRF4
ARGF4
ADDRLP4 0
...
;226:}
;227:
;228:int trap_BotLibLoadMap(const char *mapname) {
line 229
;229:	return syscall( BOTLIB_LOAD_MAP, mapname );
CNSTI4 206
ARGI4
ADDRFP4 0
INDIRP4
...
;230:}
;231:
;232:int trap_BotLibUpdateEntity(int ent, void /* struct bot_updateentity_s */ *bue) {
line 233
;233:	return syscall( BOTLIB_UPDATENTITY, ent, bue );
CNSTI4 207
ARGI4
ADDRFP4 0
INDIRI4
...
;234:}
;235:
;236:int trap_BotLibTest(int parm0, char *parm1, vec3_t parm2, vec3_t parm3) {
line 237
;237:	return syscall( BOTLIB_TEST, parm0, parm1, parm2, parm3 );
CNSTI4 208
ARGI4
ADDRFP4 0
INDIRI4
...
;238:}
;239:
;240:int trap_BotGetSnapshotEntity( int clientNum, int sequence ) {
line 241
;241:	return syscall( BOTLIB_GET_SNAPSHOT_ENTITY, clientNum, sequence );
CNSTI4 209
ARGI4
ADDRFP4 0
INDIRI4
...
;242:}
;243:
;244:int trap_BotGetServerCommand(int clientNum, char *message, int size) {
line 245
;245:	return syscall( BOTLIB_GET_CONSOLE_MESSAGE, clientNum, message, size );
CNSTI4 210
ARGI4
ADDRFP4 0
INDIRI4
...
;246:}
;247:
;248:void trap_BotUserCommand(int clientNum, usercmd_t *ucmd) {
line 249
;249:	syscall( BOTLIB_USER_COMMAND, clientNum, ucmd );
CNSTI4 211
ARGI4
ADDRFP4 0
INDIRI4
...
line 252
;251:
;252:void trap_AAS_EntityInfo(int entnum, void /* struct aas_entityinfo_s */ *info) {
line 253
;253:	syscall( BOTLIB_AAS_ENTITY_INFO, entnum, info );
CNSTI4 303
ARGI4
ADDRFP4 0
INDIRI4
...
line 256
;255:
;256:int trap_AAS_Initialized(void) {
line 257
;257:	return syscall( BOTLIB_AAS_INITIALIZED );
CNSTI4 304
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;258:}
;259:
;260:void trap_AAS_PresenceTypeBoundingBox(int presencetype, vec3_t mins, vec3_t maxs) {
line 261
;261:	syscall( BOTLIB_AAS_PRESENCE_TYPE_BOUNDING_BOX, presencetype, mins, maxs );
CNSTI4 305
ARGI4
ADDRFP4 0
INDIRI4
...
line 264
;263:
;264:float trap_AAS_Time(void) {
line 266
;265:	int temp;
;266:	temp = syscall( BOTLIB_AAS_TIME );
CNSTI4 306
ARGI4
ADDRLP4 4
ADDRGP4 syscall
...
;268:}
;269:
;270:int trap_AAS_PointAreaNum(vec3_t point) {
line 271
;271:	return syscall( BOTLIB_AAS_POINT_AREA_NUM, point );
CNSTI4 307
ARGI4
ADDRFP4 0
INDIRP4
...
;272:}
;273:
;274:int trap_AAS_PointReachabilityAreaIndex(vec3_t point) {
line 275
;275:	return syscall( BOTLIB_AAS_POINT_REACHABILITY_AREA_INDEX, point );
CNSTI4 577
ARGI4
ADDRFP4 0
INDIRP4
...
;276:}
;277:
;278:int trap_AAS_TraceAreas(vec3_t start, vec3_t end, int *areas, vec3_t *points, int maxareas) {
line 279
;279:	return syscall( BOTLIB_AAS_TRACE_AREAS, start, end, areas, points, maxareas );
CNSTI4 308
ARGI4
ADDRFP4 0
INDIRP4
...
;280:}
;281:
;282:int trap_AAS_BBoxAreas(vec3_t absmins, vec3_t absmaxs, int *areas, int maxareas) {
line 283
;283:	return syscall( BOTLIB_AAS_BBOX_AREAS, absmins, absmaxs, areas, maxareas );
CNSTI4 301
ARGI4
ADDRFP4 0
INDIRP4
...
;284:}
;285:
;286:int trap_AAS_AreaInfo( int areanum, void /* struct aas_areainfo_s */ *info ) {
line 287
;287:	return syscall( BOTLIB_AAS_AREA_INFO, areanum, info );
CNSTI4 302
ARGI4
ADDRFP4 0
INDIRI4
...
;288:}
;289:
;290:int trap_AAS_PointContents(vec3_t point) {
line 291
;291:	return syscall( BOTLIB_AAS_POINT_CONTENTS, point );
CNSTI4 309
ARGI4
ADDRFP4 0
INDIRP4
...
;292:}
;293:
;294:int trap_AAS_NextBSPEntity(int ent) {
line 295
;295:	return syscall( BOTLIB_AAS_NEXT_BSP_ENTITY, ent );
CNSTI4 310
ARGI4
ADDRFP4 0
INDIRI4
...
;296:}
;297:
;298:int trap_AAS_ValueForBSPEpairKey(int ent, char *key, char *value, int size) {
line 299
;299:	return syscall( BOTLIB_AAS_VALUE_FOR_BSP_EPAIR_KEY, ent, key, value, size );
CNSTI4 311
ARGI4
ADDRFP4 0
INDIRI4
...
;300:}
;301:
;302:int trap_AAS_VectorForBSPEpairKey(int ent, char *key, vec3_t v) {
line 303
;303:	return syscall( BOTLIB_AAS_VECTOR_FOR_BSP_EPAIR_KEY, ent, key, v );
CNSTI4 312
ARGI4
ADDRFP4 0
INDIRI4
...
;304:}
;305:
;306:int trap_AAS_FloatForBSPEpairKey(int ent, char *key, float *value) {
line 307
;307:	return syscall( BOTLIB_AAS_FLOAT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 313
ARGI4
ADDRFP4 0
INDIRI4
...
;308:}
;309:
;310:int trap_AAS_IntForBSPEpairKey(int ent, char *key, int *value) {
line 311
;311:	return syscall( BOTLIB_AAS_INT_FOR_BSP_EPAIR_KEY, ent, key, value );
CNSTI4 314
ARGI4
ADDRFP4 0
INDIRI4
...
;312:}
;313:
;314:int trap_AAS_AreaReachability(int areanum) {
line 315
;315:	return syscall( BOTLIB_AAS_AREA_REACHABILITY, areanum );
CNSTI4 315
ARGI4
ADDRFP4 0
INDIRI4
...
;316:}
;317:
;318:int trap_AAS_AreaTravelTimeToGoalArea(int areanum, vec3_t origin, int goalareanum, int travelflags) {
line 319
;319:	return syscall( BOTLIB_AAS_AREA_TRAVEL_TIME_TO_GOAL_AREA, areanum, origin, goalareanum, travelflags );
CNSTI4 316
ARGI4
ADDRFP4 0
INDIRI4
...
;320:}
;321:
;322:int trap_AAS_EnableRoutingArea( int areanum, int enable ) {
line 323
;323:	return syscall( BOTLIB_AAS_ENABLE_ROUTING_AREA, areanum, enable );
CNSTI4 300
ARGI4
ADDRFP4 0
INDIRI4
...
;324:}
;325:
;326:int trap_AAS_PredictRoute(void /*struct aas_predictroute_s*/ *route, int areanum, vec3_t origin,
;327:							int goalareanum, int travelflags, int maxareas, int maxtime,
;328:							int stopevent, int stopcontents, int stoptfl, int stopareanum) {
line 329
;329:	return syscall( BOTLIB_AAS_PREDICT_ROUTE, route, areanum, origin, goalareanum, travelflags, maxareas, maxtime, stopevent, stopcontents, stoptfl, stopareanum );
CNSTI4 576
ARGI4
ADDRFP4 0
INDIRP4
...
;330:}
;331:
;332:int trap_AAS_AlternativeRouteGoals(vec3_t start, int startareanum, vec3_t goal, int goalareanum, int travelflags,
;333:										void /*struct aas_altroutegoal_s*/ *altroutegoals, int maxaltroutegoals,
;334:										int type) {
line 335
;335:	return syscall( BOTLIB_AAS_ALTERNATIVE_ROUTE_GOAL, start, startareanum, goal, goalareanum, travelflags, altroutegoals, maxaltroutegoals, type );
CNSTI4 575
ARGI4
ADDRFP4 0
INDIRP4
...
;336:}
;337:
;338:int trap_AAS_Swimming(vec3_t origin) {
line 339
;339:	return syscall( BOTLIB_AAS_SWIMMING, origin );
CNSTI4 317
ARGI4
ADDRFP4 0
INDIRP4
...
;340:}
;341:
;342:int trap_AAS_PredictClientMovement(void /* struct aas_clientmove_s */ *move, int entnum, vec3_t origin, int presencetype, int onground, vec3_t velocity, vec3_t cmdmove, int cmdframes, int maxframes, float frametime, int stopevent, int stopareanum, int visualize) {
line 343
;343:	return syscall( BOTLIB_AAS_PREDICT_CLIENT_MOVEMENT, move, entnum, origin, presencetype, onground, velocity, cmdmove, cmdframes, maxframes, PASSFLOAT(frametime), stopevent, stopareanum, visualize );
ADDRFP4 36
INDIRF4
ARGF4
ADDRLP4 0
...
;344:}
;345:
;346:void trap_EA_Say(int client, char *str) {
line 347
;347:	syscall( BOTLIB_EA_SAY, client, str );
CNSTI4 400
ARGI4
ADDRFP4 0
INDIRI4
...
line 350
;349:
;350:void trap_EA_SayTeam(int client, char *str) {
line 351
;351:	syscall( BOTLIB_EA_SAY_TEAM, client, str );
CNSTI4 401
ARGI4
ADDRFP4 0
INDIRI4
...
line 354
;353:
;354:void trap_EA_Command(int client, char *command) {
line 355
;355:	syscall( BOTLIB_EA_COMMAND, client, command );
CNSTI4 402
ARGI4
ADDRFP4 0
INDIRI4
...
line 358
;357:
;358:void trap_EA_Action(int client, int action) {
line 359
;359:	syscall( BOTLIB_EA_ACTION, client, action );
CNSTI4 403
ARGI4
ADDRFP4 0
INDIRI4
...
line 362
;361:
;362:void trap_EA_Gesture(int client) {
line 363
;363:	syscall( BOTLIB_EA_GESTURE, client );
CNSTI4 404
ARGI4
ADDRFP4 0
INDIRI4
...
line 366
;365:
;366:void trap_EA_Talk(int client) {
line 367
;367:	syscall( BOTLIB_EA_TALK, client );
CNSTI4 405
ARGI4
ADDRFP4 0
INDIRI4
...
line 370
;369:
;370:void trap_EA_Attack(int client) {
line 371
;371:	syscall( BOTLIB_EA_ATTACK, client );
CNSTI4 406
ARGI4
ADDRFP4 0
INDIRI4
...
line 374
;373:
;374:void trap_EA_Use(int client) {
line 375
;375:	syscall( BOTLIB_EA_USE, client );
CNSTI4 407
ARGI4
ADDRFP4 0
INDIRI4
...
line 378
;377:
;378:void trap_EA_Respawn(int client) {
line 379
;379:	syscall( BOTLIB_EA_RESPAWN, client );
CNSTI4 408
ARGI4
ADDRFP4 0
INDIRI4
...
line 382
;381:
;382:void trap_EA_Crouch(int client) {
line 383
;383:	syscall( BOTLIB_EA_CROUCH, client );
CNSTI4 409
ARGI4
ADDRFP4 0
INDIRI4
...
line 386
;385:
;386:void trap_EA_MoveUp(int client) {
line 387
;387:	syscall( BOTLIB_EA_MOVE_UP, client );
CNSTI4 410
ARGI4
ADDRFP4 0
INDIRI4
...
line 390
;389:
;390:void trap_EA_MoveDown(int client) {
line 391
;391:	syscall( BOTLIB_EA_MOVE_DOWN, client );
CNSTI4 411
ARGI4
ADDRFP4 0
INDIRI4
...
line 394
;393:
;394:void trap_EA_MoveForward(int client) {
line 395
;395:	syscall( BOTLIB_EA_MOVE_FORWARD, client );
CNSTI4 412
ARGI4
ADDRFP4 0
INDIRI4
...
line 398
;397:
;398:void trap_EA_MoveBack(int client) {
line 399
;399:	syscall( BOTLIB_EA_MOVE_BACK, client );
CNSTI4 413
ARGI4
ADDRFP4 0
INDIRI4
...
line 402
;401:
;402:void trap_EA_MoveLeft(int client) {
line 403
;403:	syscall( BOTLIB_EA_MOVE_LEFT, client );
CNSTI4 414
ARGI4
ADDRFP4 0
INDIRI4
...
line 406
;405:
;406:void trap_EA_MoveRight(int client) {
line 407
;407:	syscall( BOTLIB_EA_MOVE_RIGHT, client );
CNSTI4 415
ARGI4
ADDRFP4 0
INDIRI4
...
line 410
;409:
;410:void trap_EA_SelectWeapon(int client, int weapon) {
line 411
;411:	syscall( BOTLIB_EA_SELECT_WEAPON, client, weapon );
CNSTI4 416
ARGI4
ADDRFP4 0
INDIRI4
...
line 414
;413:
;414:void trap_EA_Jump(int client) {
line 415
;415:	syscall( BOTLIB_EA_JUMP, client );
CNSTI4 417
ARGI4
ADDRFP4 0
INDIRI4
...
line 418
;417:
;418:void trap_EA_DelayedJump(int client) {
line 419
;419:	syscall( BOTLIB_EA_DELAYED_JUMP, client );
CNSTI4 418
ARGI4
ADDRFP4 0
INDIRI4
...
line 422
;421:
;422:void trap_EA_Move(int client, vec3_t dir, float speed) {
line 423
;423:	syscall( BOTLIB_EA_MOVE, client, dir, PASSFLOAT(speed) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 426
;425:
;426:void trap_EA_View(int client, vec3_t viewangles) {
line 427
;427:	syscall( BOTLIB_EA_VIEW, client, viewangles );
CNSTI4 420
ARGI4
ADDRFP4 0
INDIRI4
...
line 430
;429:
;430:void trap_EA_EndRegular(int client, float thinktime) {
line 431
;431:	syscall( BOTLIB_EA_END_REGULAR, client, PASSFLOAT(thinktime) );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 434
;433:
;434:void trap_EA_GetInput(int client, float thinktime, void /* struct bot_input_s */ *input) {
line 435
;435:	syscall( BOTLIB_EA_GET_INPUT, client, PASSFLOAT(thinktime), input );
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
line 438
;437:
;438:void trap_EA_ResetInput(int client) {
line 439
;439:	syscall( BOTLIB_EA_RESET_INPUT, client );
CNSTI4 423
ARGI4
ADDRFP4 0
INDIRI4
...
line 442
;441:
;442:int trap_BotLoadCharacter(char *charfile, float skill) {
line 443
;443:	return syscall( BOTLIB_AI_LOAD_CHARACTER, charfile, PASSFLOAT(skill));
ADDRFP4 4
INDIRF4
ARGF4
ADDRLP4 0
...
;444:}
;445:
;446:void trap_BotFreeCharacter(int character) {
line 447
;447:	syscall( BOTLIB_AI_FREE_CHARACTER, character );
CNSTI4 501
ARGI4
ADDRFP4 0
INDIRI4
...
line 450
;449:
;450:float trap_Characteristic_Float(int character, int index) {
line 452
;451:	int temp;
;452:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_FLOAT, character, index );
CNSTI4 502
ARGI4
ADDRFP4 0
INDIRI4
...
;454:}
;455:
;456:float trap_Characteristic_BFloat(int character, int index, float min, float max) {
line 458
;457:	int temp;
;458:	temp = syscall( BOTLIB_AI_CHARACTERISTIC_BFLOAT, character, index, PASSFLOAT(min), PASSFLOAT(max) );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 4
...
;460:}
;461:
;462:int trap_Characteristic_Integer(int character, int index) {
line 463
;463:	return syscall( BOTLIB_AI_CHARACTERISTIC_INTEGER, character, index );
CNSTI4 504
ARGI4
ADDRFP4 0
INDIRI4
...
;464:}
;465:
;466:int trap_Characteristic_BInteger(int character, int index, int min, int max) {
line 467
;467:	return syscall( BOTLIB_AI_CHARACTERISTIC_BINTEGER, character, index, min, max );
CNSTI4 505
ARGI4
ADDRFP4 0
INDIRI4
...
;468:}
;469:
;470:void trap_Characteristic_String(int character, int index, char *buf, int size) {
line 471
;471:	syscall( BOTLIB_AI_CHARACTERISTIC_STRING, character, index, buf, size );
CNSTI4 506
ARGI4
ADDRFP4 0
INDIRI4
...
line 474
;473:
;474:int trap_BotAllocChatState(void) {
line 475
;475:	return syscall( BOTLIB_AI_ALLOC_CHAT_STATE );
CNSTI4 507
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;476:}
;477:
;478:void trap_BotFreeChatState(int handle) {
line 479
;479:	syscall( BOTLIB_AI_FREE_CHAT_STATE, handle );
CNSTI4 508
ARGI4
ADDRFP4 0
INDIRI4
...
line 482
;481:
;482:void trap_BotQueueConsoleMessage(int chatstate, int type, char *message) {
line 483
;483:	syscall( BOTLIB_AI_QUEUE_CONSOLE_MESSAGE, chatstate, type, message );
CNSTI4 509
ARGI4
ADDRFP4 0
INDIRI4
...
line 486
;485:
;486:void trap_BotRemoveConsoleMessage(int chatstate, int handle) {
line 487
;487:	syscall( BOTLIB_AI_REMOVE_CONSOLE_MESSAGE, chatstate, handle );
CNSTI4 510
ARGI4
ADDRFP4 0
INDIRI4
...
line 490
;489:
;490:int trap_BotNextConsoleMessage(int chatstate, void /* struct bot_consolemessage_s */ *cm) {
line 491
;491:	return syscall( BOTLIB_AI_NEXT_CONSOLE_MESSAGE, chatstate, cm );
CNSTI4 511
ARGI4
ADDRFP4 0
INDIRI4
...
;492:}
;493:
;494:int trap_BotNumConsoleMessages(int chatstate) {
line 495
;495:	return syscall( BOTLIB_AI_NUM_CONSOLE_MESSAGE, chatstate );
CNSTI4 512
ARGI4
ADDRFP4 0
INDIRI4
...
;496:}
;497:
;498:void trap_BotInitialChat(int chatstate, char *type, int mcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 499
;499:	syscall( BOTLIB_AI_INITIAL_CHAT, chatstate, type, mcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 513
ARGI4
ADDRFP4 0
INDIRI4
...
line 502
;501:
;502:int	trap_BotNumInitialChats(int chatstate, char *type) {
line 503
;503:	return syscall( BOTLIB_AI_NUM_INITIAL_CHATS, chatstate, type );
CNSTI4 569
ARGI4
ADDRFP4 0
INDIRI4
...
;504:}
;505:
;506:int trap_BotReplyChat(int chatstate, char *message, int mcontext, int vcontext, char *var0, char *var1, char *var2, char *var3, char *var4, char *var5, char *var6, char *var7 ) {
line 507
;507:	return syscall( BOTLIB_AI_REPLY_CHAT, chatstate, message, mcontext, vcontext, var0, var1, var2, var3, var4, var5, var6, var7 );
CNSTI4 514
ARGI4
ADDRFP4 0
INDIRI4
...
;508:}
;509:
;510:int trap_BotChatLength(int chatstate) {
line 511
;511:	return syscall( BOTLIB_AI_CHAT_LENGTH, chatstate );
CNSTI4 515
ARGI4
ADDRFP4 0
INDIRI4
...
;512:}
;513:
;514:void trap_BotEnterChat(int chatstate, int client, int sendto) {
line 515
;515:	syscall( BOTLIB_AI_ENTER_CHAT, chatstate, client, sendto );
CNSTI4 516
ARGI4
ADDRFP4 0
INDIRI4
...
line 518
;517:
;518:void trap_BotGetChatMessage(int chatstate, char *buf, int size) {
line 519
;519:	syscall( BOTLIB_AI_GET_CHAT_MESSAGE, chatstate, buf, size);
CNSTI4 570
ARGI4
ADDRFP4 0
INDIRI4
...
line 522
;521:
;522:int trap_StringContains(char *str1, char *str2, int casesensitive) {
line 523
;523:	return syscall( BOTLIB_AI_STRING_CONTAINS, str1, str2, casesensitive );
CNSTI4 517
ARGI4
ADDRFP4 0
INDIRP4
...
;524:}
;525:
;526:int trap_BotFindMatch(char *str, void /* struct bot_match_s */ *match, unsigned long int context) {
line 527
;527:	return syscall( BOTLIB_AI_FIND_MATCH, str, match, context );
CNSTI4 518
ARGI4
ADDRFP4 0
INDIRP4
...
;528:}
;529:
;530:void trap_BotMatchVariable(void /* struct bot_match_s */ *match, int variable, char *buf, int size) {
line 531
;531:	syscall( BOTLIB_AI_MATCH_VARIABLE, match, variable, buf, size );
CNSTI4 519
ARGI4
ADDRFP4 0
INDIRP4
...
line 534
;533:
;534:void trap_UnifyWhiteSpaces(char *string) {
line 535
;535:	syscall( BOTLIB_AI_UNIFY_WHITE_SPACES, string );
CNSTI4 520
ARGI4
ADDRFP4 0
INDIRP4
...
line 538
;537:
;538:void trap_BotReplaceSynonyms(char *string, unsigned long int context) {
line 539
;539:	syscall( BOTLIB_AI_REPLACE_SYNONYMS, string, context );
CNSTI4 521
ARGI4
ADDRFP4 0
INDIRP4
...
line 542
;541:
;542:int trap_BotLoadChatFile(int chatstate, char *chatfile, char *chatname) {
line 543
;543:	return syscall( BOTLIB_AI_LOAD_CHAT_FILE, chatstate, chatfile, chatname );
CNSTI4 522
ARGI4
ADDRFP4 0
INDIRI4
...
;544:}
;545:
;546:void trap_BotSetChatGender(int chatstate, int gender) {
line 547
;547:	syscall( BOTLIB_AI_SET_CHAT_GENDER, chatstate, gender );
CNSTI4 523
ARGI4
ADDRFP4 0
INDIRI4
...
line 550
;549:
;550:void trap_BotSetChatName(int chatstate, char *name, int client) {
line 551
;551:	syscall( BOTLIB_AI_SET_CHAT_NAME, chatstate, name, client );
CNSTI4 524
ARGI4
ADDRFP4 0
INDIRI4
...
line 554
;553:
;554:void trap_BotResetGoalState(int goalstate) {
line 555
;555:	syscall( BOTLIB_AI_RESET_GOAL_STATE, goalstate );
CNSTI4 525
ARGI4
ADDRFP4 0
INDIRI4
...
line 558
;557:
;558:void trap_BotResetAvoidGoals(int goalstate) {
line 559
;559:	syscall( BOTLIB_AI_RESET_AVOID_GOALS, goalstate );
CNSTI4 526
ARGI4
ADDRFP4 0
INDIRI4
...
line 562
;561:
;562:void trap_BotRemoveFromAvoidGoals(int goalstate, int number) {
line 563
;563:	syscall( BOTLIB_AI_REMOVE_FROM_AVOID_GOALS, goalstate, number);
CNSTI4 571
ARGI4
ADDRFP4 0
INDIRI4
...
line 566
;565:
;566:void trap_BotPushGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 567
;567:	syscall( BOTLIB_AI_PUSH_GOAL, goalstate, goal );
CNSTI4 527
ARGI4
ADDRFP4 0
INDIRI4
...
line 570
;569:
;570:void trap_BotPopGoal(int goalstate) {
line 571
;571:	syscall( BOTLIB_AI_POP_GOAL, goalstate );
CNSTI4 528
ARGI4
ADDRFP4 0
INDIRI4
...
line 574
;573:
;574:void trap_BotEmptyGoalStack(int goalstate) {
line 575
;575:	syscall( BOTLIB_AI_EMPTY_GOAL_STACK, goalstate );
CNSTI4 529
ARGI4
ADDRFP4 0
INDIRI4
...
line 578
;577:
;578:void trap_BotDumpAvoidGoals(int goalstate) {
line 579
;579:	syscall( BOTLIB_AI_DUMP_AVOID_GOALS, goalstate );
CNSTI4 530
ARGI4
ADDRFP4 0
INDIRI4
...
line 582
;581:
;582:void trap_BotDumpGoalStack(int goalstate) {
line 583
;583:	syscall( BOTLIB_AI_DUMP_GOAL_STACK, goalstate );
CNSTI4 531
ARGI4
ADDRFP4 0
INDIRI4
...
line 586
;585:
;586:void trap_BotGoalName(int number, char *name, int size) {
line 587
;587:	syscall( BOTLIB_AI_GOAL_NAME, number, name, size );
CNSTI4 532
ARGI4
ADDRFP4 0
INDIRI4
...
line 590
;589:
;590:int trap_BotGetTopGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 591
;591:	return syscall( BOTLIB_AI_GET_TOP_GOAL, goalstate, goal );
CNSTI4 533
ARGI4
ADDRFP4 0
INDIRI4
...
;592:}
;593:
;594:int trap_BotGetSecondGoal(int goalstate, void /* struct bot_goal_s */ *goal) {
line 595
;595:	return syscall( BOTLIB_AI_GET_SECOND_GOAL, goalstate, goal );
CNSTI4 534
ARGI4
ADDRFP4 0
INDIRI4
...
;596:}
;597:
;598:int trap_BotChooseLTGItem(int goalstate, vec3_t origin, int *inventory, int travelflags) {
line 599
;599:	return syscall( BOTLIB_AI_CHOOSE_LTG_ITEM, goalstate, origin, inventory, travelflags );
CNSTI4 535
ARGI4
ADDRFP4 0
INDIRI4
...
;600:}
;601:
;602:int trap_BotChooseNBGItem(int goalstate, vec3_t origin, int *inventory, int travelflags, void /* struct bot_goal_s */ *ltg, float maxtime) {
line 603
;603:	return syscall( BOTLIB_AI_CHOOSE_NBG_ITEM, goalstate, origin, inventory, travelflags, ltg, PASSFLOAT(maxtime) );
ADDRFP4 20
INDIRF4
ARGF4
ADDRLP4 0
...
;604:}
;605:
;606:int trap_BotTouchingGoal(vec3_t origin, void /* struct bot_goal_s */ *goal) {
line 607
;607:	return syscall( BOTLIB_AI_TOUCHING_GOAL, origin, goal );
CNSTI4 537
ARGI4
ADDRFP4 0
INDIRP4
...
;608:}
;609:
;610:int trap_BotItemGoalInVisButNotVisible(int viewer, vec3_t eye, vec3_t viewangles, void /* struct bot_goal_s */ *goal) {
line 611
;611:	return syscall( BOTLIB_AI_ITEM_GOAL_IN_VIS_BUT_NOT_VISIBLE, viewer, eye, viewangles, goal );
CNSTI4 538
ARGI4
ADDRFP4 0
INDIRI4
...
;612:}
;613:
;614:int trap_BotGetLevelItemGoal(int index, char *classname, void /* struct bot_goal_s */ *goal) {
line 615
;615:	return syscall( BOTLIB_AI_GET_LEVEL_ITEM_GOAL, index, classname, goal );
CNSTI4 539
ARGI4
ADDRFP4 0
INDIRI4
...
;616:}
;617:
;618:int trap_BotGetNextCampSpotGoal(int num, void /* struct bot_goal_s */ *goal) {
line 619
;619:	return syscall( BOTLIB_AI_GET_NEXT_CAMP_SPOT_GOAL, num, goal );
CNSTI4 567
ARGI4
ADDRFP4 0
INDIRI4
...
;620:}
;621:
;622:int trap_BotGetMapLocationGoal(char *name, void /* struct bot_goal_s */ *goal) {
line 623
;623:	return syscall( BOTLIB_AI_GET_MAP_LOCATION_GOAL, name, goal );
CNSTI4 568
ARGI4
ADDRFP4 0
INDIRP4
...
;624:}
;625:
;626:float trap_BotAvoidGoalTime(int goalstate, int number) {
line 628
;627:	int temp;
;628:	temp = syscall( BOTLIB_AI_AVOID_GOAL_TIME, goalstate, number );
CNSTI4 540
ARGI4
ADDRFP4 0
INDIRI4
...
;630:}
;631:
;632:void trap_BotSetAvoidGoalTime(int goalstate, int number, float avoidtime) {
line 633
;633:	syscall( BOTLIB_AI_SET_AVOID_GOAL_TIME, goalstate, number, PASSFLOAT(avoidtime));
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 636
;635:
;636:void trap_BotInitLevelItems(void) {
line 637
;637:	syscall( BOTLIB_AI_INIT_LEVEL_ITEMS );
CNSTI4 541
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 640
;639:
;640:void trap_BotUpdateEntityItems(void) {
line 641
;641:	syscall( BOTLIB_AI_UPDATE_ENTITY_ITEMS );
CNSTI4 542
ARGI4
ADDRGP4 syscall
INDIRP4
...
line 644
;643:
;644:int trap_BotLoadItemWeights(int goalstate, char *filename) {
line 645
;645:	return syscall( BOTLIB_AI_LOAD_ITEM_WEIGHTS, goalstate, filename );
CNSTI4 543
ARGI4
ADDRFP4 0
INDIRI4
...
;646:}
;647:
;648:void trap_BotFreeItemWeights(int goalstate) {
line 649
;649:	syscall( BOTLIB_AI_FREE_ITEM_WEIGHTS, goalstate );
CNSTI4 544
ARGI4
ADDRFP4 0
INDIRI4
...
line 652
;651:
;652:void trap_BotInterbreedGoalFuzzyLogic(int parent1, int parent2, int child) {
line 653
;653:	syscall( BOTLIB_AI_INTERBREED_GOAL_FUZZY_LOGIC, parent1, parent2, child );
CNSTI4 565
ARGI4
ADDRFP4 0
INDIRI4
...
line 656
;655:
;656:void trap_BotSaveGoalFuzzyLogic(int goalstate, char *filename) {
line 657
;657:	syscall( BOTLIB_AI_SAVE_GOAL_FUZZY_LOGIC, goalstate, filename );
CNSTI4 545
ARGI4
ADDRFP4 0
INDIRI4
...
line 660
;659:
;660:void trap_BotMutateGoalFuzzyLogic(int goalstate, float range) {
line 661
;661:	syscall( BOTLIB_AI_MUTATE_GOAL_FUZZY_LOGIC, goalstate, range );
CNSTI4 566
ARGI4
ADDRFP4 0
INDIRI4
...
line 664
;663:
;664:int trap_BotAllocGoalState(int state) {
line 665
;665:	return syscall( BOTLIB_AI_ALLOC_GOAL_STATE, state );
CNSTI4 546
ARGI4
ADDRFP4 0
INDIRI4
...
;666:}
;667:
;668:void trap_BotFreeGoalState(int handle) {
line 669
;669:	syscall( BOTLIB_AI_FREE_GOAL_STATE, handle );
CNSTI4 547
ARGI4
ADDRFP4 0
INDIRI4
...
line 672
;671:
;672:void trap_BotResetMoveState(int movestate) {
line 673
;673:	syscall( BOTLIB_AI_RESET_MOVE_STATE, movestate );
CNSTI4 548
ARGI4
ADDRFP4 0
INDIRI4
...
line 676
;675:
;676:void trap_BotAddAvoidSpot(int movestate, vec3_t origin, float radius, int type) {
line 677
;677:	syscall( BOTLIB_AI_ADD_AVOID_SPOT, movestate, origin, PASSFLOAT(radius), type);
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
line 680
;679:
;680:void trap_BotMoveToGoal(void /* struct bot_moveresult_s */ *result, int movestate, void /* struct bot_goal_s */ *goal, int travelflags) {
line 681
;681:	syscall( BOTLIB_AI_MOVE_TO_GOAL, result, movestate, goal, travelflags );
CNSTI4 549
ARGI4
ADDRFP4 0
INDIRP4
...
line 684
;683:
;684:int trap_BotMoveInDirection(int movestate, vec3_t dir, float speed, int type) {
line 685
;685:	return syscall( BOTLIB_AI_MOVE_IN_DIRECTION, movestate, dir, PASSFLOAT(speed), type );
ADDRFP4 8
INDIRF4
ARGF4
ADDRLP4 0
...
;686:}
;687:
;688:void trap_BotResetAvoidReach(int movestate) {
line 689
;689:	syscall( BOTLIB_AI_RESET_AVOID_REACH, movestate );
CNSTI4 551
ARGI4
ADDRFP4 0
INDIRI4
...
line 692
;691:
;692:void trap_BotResetLastAvoidReach(int movestate) {
line 693
;693:	syscall( BOTLIB_AI_RESET_LAST_AVOID_REACH,movestate  );
CNSTI4 552
ARGI4
ADDRFP4 0
INDIRI4
...
line 696
;695:
;696:int trap_BotReachabilityArea(vec3_t origin, int testground) {
line 697
;697:	return syscall( BOTLIB_AI_REACHABILITY_AREA, origin, testground );
CNSTI4 553
ARGI4
ADDRFP4 0
INDIRP4
...
;698:}
;699:
;700:int trap_BotMovementViewTarget(int movestate, void /* struct bot_goal_s */ *goal, int travelflags, float lookahead, vec3_t target) {
line 701
;701:	return syscall( BOTLIB_AI_MOVEMENT_VIEW_TARGET, movestate, goal, travelflags, PASSFLOAT(lookahead), target );
ADDRFP4 12
INDIRF4
ARGF4
ADDRLP4 0
...
;702:}
;703:
;704:int trap_BotPredictVisiblePosition(vec3_t origin, int areanum, void /* struct bot_goal_s */ *goal, int travelflags, vec3_t target) {
line 705
;705:	return syscall( BOTLIB_AI_PREDICT_VISIBLE_POSITION, origin, areanum, goal, travelflags, target );
CNSTI4 572
ARGI4
ADDRFP4 0
INDIRP4
...
;706:}
;707:
;708:int trap_BotAllocMoveState(void) {
line 709
;709:	return syscall( BOTLIB_AI_ALLOC_MOVE_STATE );
CNSTI4 555
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;710:}
;711:
;712:void trap_BotFreeMoveState(int handle) {
line 713
;713:	syscall( BOTLIB_AI_FREE_MOVE_STATE, handle );
CNSTI4 556
ARGI4
ADDRFP4 0
INDIRI4
...
line 716
;715:
;716:void trap_BotInitMoveState(int handle, void /* struct bot_initmove_s */ *initmove) {
line 717
;717:	syscall( BOTLIB_AI_INIT_MOVE_STATE, handle, initmove );
CNSTI4 557
ARGI4
ADDRFP4 0
INDIRI4
...
line 720
;719:
;720:int trap_BotChooseBestFightWeapon(int weaponstate, int *inventory) {
line 721
;721:	return syscall( BOTLIB_AI_CHOOSE_BEST_FIGHT_WEAPON, weaponstate, inventory );
CNSTI4 558
ARGI4
ADDRFP4 0
INDIRI4
...
;722:}
;723:
;724:void trap_BotGetWeaponInfo(int weaponstate, int weapon, void /* struct weaponinfo_s */ *weaponinfo) {
line 725
;725:	syscall( BOTLIB_AI_GET_WEAPON_INFO, weaponstate, weapon, weaponinfo );
CNSTI4 559
ARGI4
ADDRFP4 0
INDIRI4
...
line 728
;727:
;728:int trap_BotLoadWeaponWeights(int weaponstate, char *filename) {
line 729
;729:	return syscall( BOTLIB_AI_LOAD_WEAPON_WEIGHTS, weaponstate, filename );
CNSTI4 560
ARGI4
ADDRFP4 0
INDIRI4
...
;730:}
;731:
;732:int trap_BotAllocWeaponState(void) {
line 733
;733:	return syscall( BOTLIB_AI_ALLOC_WEAPON_STATE );
CNSTI4 561
ARGI4
ADDRLP4 0
ADDRGP4 syscall
...
;734:}
;735:
;736:void trap_BotFreeWeaponState(int weaponstate) {
line 737
;737:	syscall( BOTLIB_AI_FREE_WEAPON_STATE, weaponstate );
CNSTI4 562
ARGI4
ADDRFP4 0
INDIRI4
...
line 740
;739:
;740:void trap_BotResetWeaponState(int weaponstate) {
line 741
;741:	syscall( BOTLIB_AI_RESET_WEAPON_STATE, weaponstate );
CNSTI4 563
ARGI4
ADDRFP4 0
INDIRI4
...
line 744
;743:
;744:int trap_GeneticParentsAndChildSelection(int numranks, float *ranks, int *parent1, int *parent2, int *child) {
line 745
;745:	return syscall( BOTLIB_AI_GENETIC_PARENTS_AND_CHILD_SELECTION, numranks, ranks, parent1, parent2, child );
CNSTI4 564
ARGI4
ADDRFP4 0
INDIRI4
