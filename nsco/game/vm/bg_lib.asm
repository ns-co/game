...
;51:#if 0
;52:static char sccsid[] = "@(#)qsort.c	8.1 (Berkeley) 6/4/93";
;53:#endif
;54:static const char rcsid[] =
;55:	"$Id: bg_lib.c,v 1.1.1.1 2004/01/07 19:09:00 blutengel Exp $";
;56:#endif /* LIBC_SCCS and not lint */
;57:
;58://typedef int		 cmp_t(const void *, const void *);
;59:static char* med3(char *, char *, char *, cmp_t *);
;60:static void	 swapfunc(char *, char *, int, int);
;61:
;62:#ifndef min
...
;197:
;198:
;199:// this file is excluded from release builds because of intrinsics
;200:
;201:size_t strlen( const char *string ) {
line 204
;202:	const char	*s;
;203:
;204:	s = string;
...
;224:}
;225:
;226:char *strcpy( char *strDestination, const char *strSource ) {
line 229
;227:	char *s;
;228:
;229:	s = strDestination;
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
;236:
;237:
;238:int strcmp( const char *string1, const char *string2 ) {
ADDRGP4 $143
JUMPV
LABELV $142
line 239
;239:	while ( *string1 == *string2 && *string1 && *string2 ) {
line 240
;240:		string1++;
ADDRFP4 0
ADDRFP4 0
...
;245:
;246:
;247:char *strchr( const char *string, int c ) {
ADDRGP4 $149
JUMPV
LABELV $148
line 248
...
;255:}
;256:
;257:char *strstr( const char *string, const char *strCharSet ) {
ADDRGP4 $155
JUMPV
LABELV $154
line 258
...
;272:}
;273:
;274:#if !defined ( _MSC_VER ) && ! defined ( __linux__ )
;275:
...
;759:#endif
;760:
;761:double tan( double x ) {
line 762
;762:	return sin(x) / cos(x);
ADDRFP4 0
INDIRF4
ARGF4
ADDRLP4 0
...
;764:
;765:
;766:static int randSeed = 0;
;767:
;768:void	srand( unsigned seed ) {
line 769
;769:	randSeed = seed;
ADDRGP4 randSeed
ADDRFP4 0
...
;775:}
;776:
;777:double atof( const char *string ) {
ADDRGP4 $187
JUMPV
LABELV $186
line 784
...
line 841
;838:
;839:	// not handling 10e10 notation...
;840:
...
;842:}
;843:
;844:double _atof( const char **stringPtr ) {
line 850
...
line 907
;905:
;906:	// not handling 10e10 notation...
;907:	*stringPtr = string;
ADDRFP4 0
INDIRP4
ADDRLP4 4
INDIRP4
...
;911:
;912:
;913:#if !defined( _MSC_VER ) && !defined( __linux__ )
;914:
