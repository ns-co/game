...
/*	if (gametype == GT_CTF) {
		// ctf_redflag = sealbriefcase return point
		// ctf_blueflag = tango briefcase
...
/*	if (gametype == GT_CTF) {
	...
	{
		// todo: maybe add a 'base' entity that the bot are able to search for
		return;
	}
#if 0
	//if not addressed to this bot
